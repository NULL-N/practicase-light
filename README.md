...
<p align="center">
  <img src="docs/assets/light-badges.svg" alt="28 課題 / PHP 8.5 / Docker / SQL ドリル / 設計トレーニング / 無料・課金なし">
</p>
...
**8本の補強ドリル**も収録しています(全28課題)。

教材バージョン: **Light for PHP v2.1.0**
...
体験してもらい、仕上げに任意の**設計基礎ドリル8課題**を用意しています(全28課題)。
