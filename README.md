...
<p align="center">
  <img src="docs/assets/light-badges.svg" alt="31 課題 / PHP 8.5 / Docker / SQL ドリル / 設計トレーニング / 無料・課金なし">
</p>
...
**8本の補強ドリル**と、外部 API 連携の入口を体験する**3本の外部API入門**も収録しています(全31課題)。

教材バージョン: **Light for PHP v2.2.1**
...
体験してもらい、一周後の任意課題として**設計基礎ドリル8課題**と**外部API入門3課題**を
用意しています(全31課題)。
...
## 🗺️ 学習の地図(全31課題 = 一周20課題+補強ドリル8課題+外部API入門3課題)
