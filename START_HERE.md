...
PractiCase for PHP へようこそ。この教材は**2つの始め方**があります。好きな方を選んでください
(あとから切り替えても大丈夫です)。

フォルダ構造で迷ったら、まず **[LEARN_HERE.md](LEARN_HERE.md)** を開いてください。
詳しい地図は **[docs/03_参考資料/folder-map.md](docs/03_参考資料/folder-map.md)** です。

通常の課題管理にはRedmineを使います。初回だけ
**[Redmine運用ガイド](docs/02_作業ルール/redmine-guide.md)** に従って起動・初期化・課題投入を行ってください。
Redmineが使えない場合も、各`ticket.md`のfallback手順で学習を続けられます。
